...
public abstract class AbstractAnimal {
	/*
	 * 1.- De una clase abstracta no se pueden hacer new,
	 * pero sí se pueden crear variables.
	 * 
	 * 2.- Puede declarar una serie de métodos abstractos.
	 * 			- el que no tiene implementación
	 * 
